            ...
            child: Column(
              children: [
                TextFormField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'Nome', prefixIcon: Icon(Icons.person)),
                ...
                TextFormField(
                  ...
                  obscureText: true,
                  decoration:
                      const InputDecoration(labelText: 'Senha', prefixIcon: Icon(Icons.lock)),
                  textInputAction: TextInputAction.next,
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'Confirmar Senha', prefixIcon: Icon(Icons.lock)),
                  textInputAction: TextInputAction.next,
                  validator: (value) =>
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'Idade', prefixIcon: Icon(Icons.calendar_today)),
                  textInputAction: TextInputAction.next,
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration:
                      const InputDecoration(labelText: 'CPF', prefixIcon: Icon(Icons.credit_card)),
                  textInputAction: TextInputAction.next,
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration:
                      const InputDecoration(labelText: 'Telefone', prefixIcon: Icon(Icons.phone)),
                  textInputAction: TextInputAction.next,
                ...
                TextFormField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'E-mail', prefixIcon: Icon(Icons.email)),
